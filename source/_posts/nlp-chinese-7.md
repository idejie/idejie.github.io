---
title: 中文语义分析研究现状（CIPS2016、角色标注、篇章分析）
date: 2017-06-02 20:07:46
tags: 语义分析
category: NLP
---

![这里写图片描述](http://img.blog.csdn.net/20170218223512499?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvc2luYXRfMjY5MTczODM=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
![这里写图片描述](http://img.blog.csdn.net/20170218223519222?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvc2luYXRfMjY5MTczODM=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
词汇的歧义性是[自然语言](http://lib.csdn.net/base/nlp)的固有特征。词义消歧根据一个多义词在文本中出现的上下文环境来确定其词义，作为各项自然语言处理的基础步骤和必经阶段被提出来。词义消歧包含两个必要的步骤: 
（ 1） 在词典中描述词语的意义; 
（ 2） 在语料中进行词义自动消歧。 
...
无监督的语义分析方法不需要利用人工标注的语义分析语料，仅利用知识库（或[数据库](http://lib.csdn.net/base/mysql)） 
中的实体名/关系名等，也不利用知识库中的记录的事实。无监督的语义分析方法虽然不使 
用人工标注的语料，但通常会采用 EM [算法](http://lib.csdn.net/base/datastructure)，在每轮算法迭代中，对句子进行语义分析，并 
...
![这里写图片描述](http://img.blog.csdn.net/20170219134621483?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvc2luYXRfMjY5MTczODM=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
- 3、工具的话我推荐[Python](http://lib.csdn.net/base/python)下的NLTK，超方便！ 
